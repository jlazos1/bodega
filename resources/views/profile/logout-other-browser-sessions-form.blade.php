    ...
    <x-slot name="content">
        ...
        <div class="flex items-center mt-5">
            <x-button wire:click="confirmLogout" wire:loading.attr="disabled">
                {{ __('Cerrar las otras sesiones del navegador') }}
            </x-button>
        ...
        <x-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Por favor, ingrese su contraseña para confirmar que desea desconectarse de sus otras sesiones de navegación de todos sus dispositivos.') }}

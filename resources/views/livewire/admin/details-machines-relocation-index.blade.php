...
@section('content')
    ...
    <div class="card pr-4 pl-4 pb-5">
        ...
        {!! Form::select('machine_id', $machines, null, ['class' => 'form-control mb-2 select-asset', 'multiple' => 'multiple', 'name' => 'seleccion[]']) !!}
                ...
                <tbody>
                    @foreach ($machinesAdd as $machine)
                        <tr>
                            ...
                            <td width="10px">
                                <form action="{{ route('admin.machines-details-relocations.destroy', $machine->id) }}" method="POST">
                                    @method('DELETE')
                                    @csrf

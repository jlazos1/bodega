...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::create(['name' => 'admin.inputs.index'])->syncRoles([$admin]);
        Permission::create(['name' => 'admin.inputs.create'])->syncRoles([$admin]);
        Permission::create(['name' => 'admin.inputs.edit'])->syncRoles([$admin]);

        Permission::create(['name' => 'admin.outputs.index'])->syncRoles([$admin]);
        Permission::create(['name' => 'admin.outputs.create'])->syncRoles([$admin]);
        Permission::create(['name' => 'admin.outputs.edit'])->syncRoles([$admin]);

        Permission::create(['name' => 'admin.detalles-inputs.index'])->syncRoles([$admin]);
        Permission::create(['name' => 'admin.detalles-inputs.create'])->syncRoles([$admin]);
        Permission::create(['name' => 'admin.detalles-inputs.edit'])->syncRoles([$admin]);

        Permission::create(['name' => 'admin.detalles-outputs.index'])->syncRoles([$admin]);
        Permission::create(['name' => 'admin.detalles-outputs.create'])->syncRoles([$admin]);
        Permission::create(['name' => 'admin.detalles-outputs.edit'])->syncRoles([$admin]);
        ...
        Permission::create(['name' => 'admin.products_branch.index'])->syncRoles([$admin]);
        Permission::create(['name' => 'admin.products_branch.create'])->syncRoles([$admin]);
        Permission::create(['name' => 'admin.products_branch.edit'])->syncRoles([$admin]);
        ...
        Permission::create(['name' => 'details_inputs'])->syncRoles([$admin, $tecnico]);
        Permission::create(['name' => 'details_loans'])->syncRoles([$admin, $tecnico]);
        Permission::create(['name' => 'details_outputs'])->syncRoles([$admin, $tecnico]);
